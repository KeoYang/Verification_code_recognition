...
public class Preprocess {
	...
	private void run(){
		File dir = new File("chongqing");//download3
		//鍙垪鍑簀pg
		...
		for (File file : files) {
			try {
				...
				//ImageIO.write(filterImg, "JPG", new File("liaoning_filterImg/" + file.getName()));//1_filterImg
				BufferedImage binaryImg = getBinaryImage(img);
				ImageIO.write(binaryImg, "JPG", new File("chongqing_gray/" + file.getName()));//1_gray3
