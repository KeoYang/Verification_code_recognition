...
public class Train {
	...
	/**
	 * 所有图像分类的map，key为当前类别标号，value为对应的图片，图片以二位数组的形式保存
	 */
	...
	public void svmFormat(){
		...
		try {
			writer = new PrintWriter(new File("svm/svm.jiangsu_train"));//svm/svm.train
...
//					System.out.println(tmpLine);
	...
	public static void run() throws IOException{
		//train参数
		String[] arg = {"-t","0","svm/svm.jiangsu_train","svm/svm.jiangsu_model"};//"svm/svm.train","svm/svm.model"
		
		//predict参数
		String[] parg = {"svm/svmscale.test","svm/svm.jiangsu_model","svm/jiangsu_result.txt"};
	...
	private static void produceLabel(){
		...
		try {
			...
			writer = new FileWriter(new File("svm/jiangsu_label.txt"));
			//String charactor = "1234567890abcdefghijklmnopqrstuvwxyz";
			String charactor = "23456789ABCDEFGHIJKMNPQRSTUVWXYZ";
